 ...
 */
function nationCall(params) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = (0, queryBuilder_1.default)(params);
        const data = yield calls_1.default.makeCall(`nation?APICode=${this.apiKey}${query}`);
        return data[0];
    });
}
exports.default = nationCall;
//# sourceMappingURL=nationCall.js.map