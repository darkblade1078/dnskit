 ...
 */
function memberBuildingsCall(params) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = (0, queryBuilder_1.default)(params);
        const data = yield calls_1.default.makeCall(`NationBuildings?APICode=${this.apiKey}${query}`);
        return data[0];
    });
}
exports.default = memberBuildingsCall;
//# sourceMappingURL=memberBuildingCall.js.map