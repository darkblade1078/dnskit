 ...
 */
function nationWarHistoryCall(params) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = (0, queryBuilder_1.default)(params);
        const data = yield calls_1.default.makeCall(`NationWarHistory?APICode=${this.apiKey}${query}`);
        return data;
    });
}
exports.default = nationWarHistoryCall;
//# sourceMappingURL=nationWarHistoryCall.js.map