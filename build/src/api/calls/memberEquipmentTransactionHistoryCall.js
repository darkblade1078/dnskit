 ...
 */
function memberEquipmentTransactionHistoryCall(params) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = (0, queryBuilder_1.default)(params);
        const data = yield calls_1.default.makeCall(`NationEquipmentTransactionHistory?APICode=${this.apiKey}${query}`);
        return data;
    });
}
exports.default = memberEquipmentTransactionHistoryCall;
//# sourceMappingURL=memberEquipmentTransactionHistoryCall.js.map